...
plot_distributions(mcSimulation_object = Calorie_mc_simulation,
                     ...
                     method = 'smooth_simple_overlay',
                     x_axis_name = 'Total protein need in gram',
                     base_size = 7)
  ...
  plot_distributions(mcSimulation_object = Calorie_mc_simulation,
                     ...
                     method = 'smooth_simple_overlay',
                     x_axis_name = 'Total carbohyrate need in gram',
                     base_size = 7)
  ...
  plot_distributions(mcSimulation_object = Calorie_mc_simulation,
                     vars = c("fat_need_gram_male", "fat_need_gram_female",
                              "total_fat_need_gram"),
                     method = 'smooth_simple_overlay',
                     x_axis_name = 'Total fat need in gram',
                     base_size = 7)
...
### Cashflow of the intervention one and two
...
### Total costs for intervention one and two

```{r m53}

summary(Cost_benefit_mc_simulation$y$total_cost_intervention_one)

summary(Cost_benefit_mc_simulation$y$total_cost_intervention_two)

```

Total cost for intervention one is lower than the cost for intervention two. 
...
We also did the expected value of perfect information (EVPI) analysis for both intervention.

<br>

#### EVPI for intervention one
...
output <- capture.output(evpi_one <- multi_EVPI(mc = mcSimulation_table, first_out_var = "NPV_intervention_one"))
...
#### EVPI for intervention two

```{r m56}

output <- capture.output(evpi_two <- multi_EVPI(mc = mcSimulation_table, first_out_var = "NPV_intervention_two"))
